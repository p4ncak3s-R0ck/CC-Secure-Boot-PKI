...
#       temporary focusing, entity, entity, and target
#       temporary focusing, entity, entity, and target
#
#   (2) You need a Java installation to run Gradle. If JAVA_HOME is set, it
#       will be used. Otherwise, we'll try to find Java in the PATH.
#
##############################################################################
...
# Collect all arguments for the java command, stracks://gradle.org/best-practices
